<?php
class Berita_15_rest_api extends CI_Controller
{
    var $API = "";
    ...
    function index()
    {
        ...
        $this->load->view('berita_15_rest_api/list_data', $data);
    }
    ...
    function tambah_berita()
    {
        if (isset($_POST['submit'])) {
            ...
            redirect('Berita_15_rest_api');
        } else {
            $this->load->view('berita_15_rest_api/tambah_berita');
        }
    }
    ...
    function edit_berita()
    {
        if (isset($_POST['id_berita'])) {
            ...
            $this->load->view('berita_15_rest_api/edit_berita', $data);
        }
    }
