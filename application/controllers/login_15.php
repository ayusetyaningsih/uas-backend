<?php
class Login_15 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('login/view_login_15');
        } else {
            $this->proses_login();
        }
    }
    ...
    public function proses_login()
    {
        ...
        if ($user != '' && $password != '') {
            ...
            if ($row) {
                ...
                $dataPeran = $this->Loginregister_15
                ...
                if ($dataPeran) {
                    ...
                    if ($arrayDataUser['id_peran'] == "1") {
                        $ambilUrl = $this->Loginregister_15
