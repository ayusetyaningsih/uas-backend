                        ...
                        ?>
                            <div class="row mb-3">
                                ...
                                <div class="col-2 themed-grid-col">
                                    <a class="btn btn-warning" href="<?= base_url('manage_admin_15/edit_user/' . $data->id_user) ?>" role="button">Edit</a>
                                    <a class="btn btn-danger" href="<?= base_url('manage_admin_15/hapus_user/' . $data->id_user) ?>" role="button">Hapus</a>
                                </div>
                            </div>
        ...
        $(document).on('submit', '#user_form', function(event) {
            ...
            if ((email != '') && (namaPengguna != '') && (password != '') && (konfirmPass != '')) {
                if (password == konfirmPass) {
                    $.ajax({
                        url: "<?php echo base_url('manage_admin_15/pendaftaran') ?>",
                        method: 'POST',
