            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md">
                        ...
                        <!-- <a class="btn btn-success" href=" //base_url('manage_admin_15/tambah_menu/' . $data->id_menu) ?>" role="button">Tambah</a> -->
                        <div class="row mb-3">
                        ...
                        ?>
                            <div class="row mb-3">
                                ...
                                <div class="col-2 themed-grid-col">
                                    <a class="btn btn-warning" href="<?= base_url('manage_admin_15/edit_menu/' . $data->id_menu) ?>" role="button">Edit</a>
                                    <a class="btn btn-danger" href="<?= base_url('manage_admin_15/hapus_menu/' . $data->id_menu) ?>" role="button">Hapus</a>
                                </div>
                            </div>
