                    ...
                    <div class="col-md">
                        ...
                        <div class="row mb-3">
                            <div class="card-footer clearfix">
                                <a href="<?= base_url('manage_contributor_15/tambah_kategori') ?>" role="button" class="btn btn-sm btn-info float-left">Tambah Kategori</a>
                            </div>
                        ...
                        ?>
                            <div class="row mb-3">
                                ...
                                <div class="col-2 themed-grid-col">
                                    ...
                                    ?>
                                    <a class="btn btn-warning" href="<?= base_url('manage_contributor_15/edit_kategori/' . $id_encrypt); ?>" role="button">Edit</a>
                                    <a class="btn btn-danger" href="<?= base_url('manage_contributor_15/hapus_kategori/' . $id_encrypt); ?>" role="button">Hapus</a>
                                </div>
                            </div>
